    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar">
        <div class="navbar-nav ml-auto" id="navbar-controls">
          ...
          <a class="nav-item nav-link" href="#Tatuajes">Tatuajes</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col text-uppercase text-center mt-4">
          ...
          <h2 id="Tatuajes-2">Tajuajes Galeria de</h2>
        </div>
      </div>
      <div class="row">
    ...
    <div id="" class="container-fluid">
      <div class="row">
        ...
        <div class="col-12 col-lg-6 mt-4 mb-4">
          <h2>Huaral-Lima</h2>
          <p>
          <p>Macho que se respeta con un excelente barbero cuenta.</p>

          <p>Ningún hombre se siente completo si no cuenta con un buen barbero.</p>

          <p>Tu vida puede cambiar en la barbería porque renovar tu estilo también es renovar tu vida.</p>

          <p>Renueva tu estilo. Siempre es un excelente momento para dejar de ser aburrido.</p>

          <p>Si te miras al espejo y no te gusta lo que ves en el reflejo es momento de que conozcas a un buen barbero.</p>
          </p>
    ...
    <div class="container">
      <div class="row text-center">
        ...
        <div class="col-12 col-md">
          ...
          <button type="button" class="btn btn-light">Instegram</button>
        </div>
        <div class="col-12 col-md">
